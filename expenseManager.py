...
class ExpenseManager:
    ...
    def addExpense(self, extype, amount, paidby, splits, potid, conn, item_name):
        db_table = database_entry()
        db_table.edit_entry(paidby, amount, "ADD", potid, conn)
        CreateItems.create_item(potid, item_name, "ITEM", amount, paidby, conn)
        ...
        for split in expense.getSplits():
            ...
            CreateItems.create_item(potid, item_name, "CONSUMER", split.getAmount(), paidto, conn)
